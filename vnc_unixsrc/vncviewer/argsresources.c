...
usage(void)
{
  fprintf(stderr,
	  ...
	  "        -sshvnc <USER@HOST> (SSH to host, start x11vnc, tunnel and connect)\n"
	  "        -sshvnc-display <DISPLAY> (remote X display for x11vnc, default auto)\n"
	  "        -sshvnc-persist (don't kill remote x11vnc on viewer exit)\n"
	  "\n"
